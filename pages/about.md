...
<p>Bu proje, Marmara Üniversitesi Dijital Beşeri Bilimler Uygulama ve Araştırma Merkezi (DBB-M) içerisinde Osmanlı ve Türkiye tarihine dair seçilmiş eser türleri üzerinden veri tabanı oluşturma ve dijital analiz uygulamaları gerçekleştirme amacını taşımaktadır. Proje, seçilmiş kaynak gruplarını (tevârih, seyahatname, hatırât) dikkate alarak şimdilik üç alt proje şeklinde hayata geçirilmiştir. Telif haklarına dikkat ederek, kaynak gruplarının kapsadığı eserlerin titizlikle listelenmesi, verilerinin sistematik biçimde yapılandırılması ve her kaynak grubundan seçilecek metinlerde farklı dijital yöntemlerin uygulanması amacını kapsayan bu eğitim ve araştırma projesi gönüllük esasına dayalı olarak sürmekte ve ticari amaç gütmeyen ileri araştırmalar için bir altyapı sunmayı hedeflemektedir. Proje sürecinde kazanılacak disiplinlerarası tecrübeler ve elde edilecek analiz sonuçları akademik yayın haline getirilerek, tarih disiplini yanında sosyoloji, edebiyat ve siyaset bilimi gibi farklı disiplinlerden araştırmacılara yeni perspektifler kazandıracaktır.</p>

<p><strong>GEREKÇE ve AMAÇ</strong></p>

<p>Dijital Beşeri Bilimler'in temeli büyük veri olduğundan veri kaynaklarını ulaşılabilir ve işlenebilir hale getirmek zorunluluğu bulunmaktadır. Bu projede, arşivler ve yazma eserler gibi tarihi verilerin kaynak olarak kullanılması için bu verilerin bir veri tabanı çerçevesinde derlenip, ilişkilendirilmiş başlık ve temalar şeklinde ücretsiz olarak erişilebilir kılınması ve ileri dijital analizlere hazır hale getirilmesi amaçlanmıştır. Böylece burada istifade edilen kaynakları araştırmacılar çok daha verimli kullanacaktır.</p>
